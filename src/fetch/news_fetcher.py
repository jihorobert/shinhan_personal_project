...
# query: 검색어, api_key: 뉴스 API 키, from_date: 시작 날짜,
# to_date: 종료 날짜, num_articles: 가져올 기사 수
# 각 기사의 title과 description을 포함한 리스트를 반환
def get_latest_news(query, api_key, from_date, to_date, num_articles=5):
    url = (
...
# Example usage
# print(get_latest_news('삼성', NEWSAPI_KEY, '2025-07-27', '2025-08-02'))
