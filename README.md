...
한국 주식 시장 분석을 통해 개인 투자자들이 더 나은 투자 결정을 내릴 수 있도록 돕습니다.
...
본 시스템은 **Yahoo Finance API**를 통해 **한국거래소(KRX)에 상장된 모든 기업**을 지원합니다.

### 📈 주요 지원 기업 (코스피 상위 100개 기업 포함)
...
- **에너지/화학**: LG에너지솔루션, LG화학, SK이노베이션, 한화솔루션
- **자동차**: 현대차, 기아, 현대모비스, 현대중공업
- **IT/통신**: 삼성전자, SK하이닉스, NAVER, 카카오, SK텔레콤, KT
- **바이오/제약**: 삼성바이오로직스, 셀트리온, 한미사이언스, 한미약품
- **건설/중공업**: 삼성물산, 현대건설, 대우건설, 포스코홀딩스
- **유통/소비재**: 아모레퍼시픽, LG생활건강, 롯데쇼핑, 현대백화점

### ✨ 기업명 검색 기능

- **한글명으로 검색**: "삼성전자", "현대차", "네이버" 등
- **부분 검색 지원**: "삼성", "LG", "현대" 등으로 검색 가능
- **자동 완성**: 입력한 기업명과 가장 유사한 기업을 자동으로 찾아줍니다

### 📋 전체 지원 기업 확인 방법

시스템에서 지원하는 전체 기업 목록을 확인하려면:

1. 웹 인터페이스에서 기업명 입력 시 자동완성 목록 확인
2. API 엔드포인트: `GET /api/supported-companies`
3. CLI에서: `python demo.py` 실행 후 지원 기업 목록 확인
